                    ...
                    <div class="bg-slate-50 p-4 rounded-xl space-y-3">
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            <div>
                                ...
                                <input type="number" name="nilai_hafalan" min="0" max="100" required class="w-full px-2 py-1.5 border border-slate-200 rounded-lg text-xs font-semibold bg-white text-center">
                            </div>
                            <div>
                                <label class="block text-xxs font-semibold text-slate-500 mb-1 text-center">C2: Murojaah</label>
                                <input type="number" name="nilai_murojaah" min="0" max="100" required class="w-full px-2 py-1.5 border border-slate-200 rounded-lg text-xs font-semibold bg-white text-center">
                            </div>
                            <div>
                                <label class="block text-xxs font-semibold text-slate-500 mb-1 text-center">C3: Tahsin</label>
                                <input type="number" name="nilai_tahsin" min="0" max="100" required class="w-full px-2 py-1.5 border border-slate-200 rounded-lg text-xs font-semibold bg-white text-center">
                            </div>
                        </div>
                    </div>
                ...
                <form :action="`{{ url('nilai') }}/${editNilai.santri_id}`" method="POST" class="p-6 space-y-4">
                    ...
                    <div class="bg-slate-50 p-4 rounded-xl space-y-3">
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            <div>
                                <label class="block text-xxs font-semibold text-slate-500 mb-1 text-center">C1: Hafalan</label>
                                <input type="number" name="nilai_hafalan" x-model="editNilai.nilai_hafalan" min="0" max="100" required class="w-full px-2 py-1.5 border border-slate-200 rounded-lg text-xs font-semibold bg-white text-center">
                            </div>
                            <div>
                                <label class="block text-xxs font-semibold text-slate-500 mb-1 text-center">C2: Murojaah</label>
                                <input type="number" name="nilai_murojaah" x-model="editNilai.nilai_murojaah" min="0" max="100" required class="w-full px-2 py-1.5 border border-slate-200 rounded-lg text-xs font-semibold bg-white text-center">
                            </div>
                            <div>
                                <label class="block text-xxs font-semibold text-slate-500 mb-1 text-center">C3: Tahsin</label>
                                <input type="number" name="nilai_tahsin" x-model="editNilai.nilai_tahsin" min="0" max="100" required class="w-full px-2 py-1.5 border border-slate-200 rounded-lg text-xs font-semibold bg-white text-center">
                            </div>
                        </div>
                    </div>
